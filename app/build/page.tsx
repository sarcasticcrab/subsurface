  ...
  return (
    <>
      ...
      <div style={styles.section}>
        ...
        <div style={styles.sectionRight}>
          <PartsTable parts={[
            ...
            { item: "Wago 221-412 MINI connectors (2-wire, x3)", cost: "£2–3", note: <span>One per wire: GND, D+, D−. The VCC wire is cut and not connected. Search <a href="https://www.amazon.co.uk/s?k=wago+221-412+mini" target="_blank" rel="noopener noreferrer" style={styles.partsLink}>Wago 221-412 on Amazon</a>.</span> },
        ...
        <div style={styles.sectionRight}>
          ...
          <Step num="08" title="Prepare and splice the tether cable">
            ...
            <p style={{ ...styles.stepBody, marginTop: "1rem" }}>
              ...
              Join matching wires using Wago 221-412 MINI connectors — one connector per wire.
      ...
      <Principles items={[
        ...
        { title: "PG7 gland and Wago splice", body: "The tether cable enters the jar through a PG7 gland — hand-tighten only. Inside, three wires (GND, D+, D−) are each joined to the pigtail using a Wago 221-412 MINI 2-conductor connector. The VCC wire is intentionally cut and isolated. If live view is unstable, the Wago connections on D+ and D− are the first thing to check." },
